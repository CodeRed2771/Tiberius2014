 ...
 * @author laptop
 */
public class SaitekJoystick extends GenericJoystick{
    ...
    public static final AxisButton LEFT = new AxisButton(X, true);
    public static final AxisButton RIGHT = new AxisButton(X, false);
    public static final AxisButton UP = new AxisButton(Y, true);
    public static final AxisButton DOWN = new AxisButton(Y, false);
    public static final AxisButton TWIST_LEFT = new AxisButton(TWIST, true);
    public static final AxisButton TWIST_RIGHT = new AxisButton(TWIST, false);
    public static final AxisButton TOPHAT_LEFT = new AxisButton(TOPHAT_X, true);
    public static final AxisButton TOPHAT_RIGHT = new AxisButton(TOPHAT_X, false);
    public static final AxisButton TOPHAT_UP = new AxisButton(TOPHAT_Y, true);
    public static final AxisButton TOPHAT_DOWN = new AxisButton(TOPHAT_Y, false);
